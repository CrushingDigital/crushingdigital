<template>
  ...
  >
    <div class="main">
      ...
      <p class="text-justify mb-5 bg-slate-50 p-5 rounded-2xl">
        I want to show you how the recruitment game really works. Why I say that
        the <span class="italic">"best developers rarely get the job"</span> and
        how you can make simple changes to
