          ...
          <div class="flex flex-col justify-evenly">
            <div class="flex flex-col sm:flex-row justify-between">
              <div class="flex flex-row align-start">
                <!-- ********* APPROVED **************** -->
                <span :class="dev.approved ? 'text-yellow-400' : 'text-gray-300'" class="text-sm"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6"
                    fill="none"
                ...
                ></span>
                <!-- ********* VERIFIED **************** -->
                <span :class="dev.verified ? 'text-green-500' : 'text-gray-300'" class="text-sm"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6"
                    fill="none"
